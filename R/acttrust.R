...
#' [ActTrust](https://www.condorinst.com.br/acttrust-actigrafo/)
#' actigraphy record.
#'
#' ActTrust is a trademark of
#' [Condor Instruments Ltda](https://www.condorinst.com.br/).
#'
#' __Note__: We are always looking for actigraphy data samples. If you have a
...
#' @details
#'
#' This data was created by one of the `actverse` package author and is free for
#' all kinds of use. You can download the full dataset at
#' \url{https://zenodo.org/record/4898822}.
#'
#' ## Data wrangling
#'
#' This dataset was tidied and validated with the default settings of
...
#' ## Variable naming
#'
#' The `actverse` package stick to the [tidyverse](https://www.tidyverse.org/)
#' principles. Our code and naming schemes follow the guidelines
#' of the [tidyverse style guide](https://style.tidyverse.org/).
#'
#' ## Variable classes
#'
...
#' because we think is the best standard that follows the
...
#' ## Actigraph
#'
#' * Brand: [Condor Instruments](https://www.condorinst.com.br/).
#' * Model: [ActTrust 1](https://www.condorinst.com.br/acttrust-actigrafo/).
...
#' removed.
#' * Minor adjustments were made on the sleep onset and sleep offset, taking in
#' consideration the event button and sleep diary records.
#'
...
#'
#' @format A [`tsibble][tsibble::tsibble()] with `r ncol(acttrust)`
#'   columns and `r nrow(acttrust)` rows:
#'
#' \describe{
#'   \item{timestamp}{
...
#'   editable state 1, `7` editable state 2, and `8` for editable state 3. These
#'   states can be assigned by a specialist or by a validated inference
#'   algorithm.
#'   \cr \cr
#'   R class: [`numeric`][numeric()].}
#' }
