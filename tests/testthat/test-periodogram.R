test_that("periodogram() | general test", {
  ...
  object <- periodogram(data, "x",
    p_unit = "minutes", p_min = 1000,
...
test_that("periodogram() | error test", {
  ...
  data_3 <- dplyr::tibble(
    index = c(
      lubridate::as_datetime(seq(0, 60 * 100, by = 60)),
...
test_that("find_periodogram_peaks() | error test", {
  ...
  # prettycheck::assert_identical(p_seq, q_p, q_p_critical, ...
  find_periodogram_peaks(
    p_seq = 1,
    q_p = 1,
    q_p_critical = 1,
...
test_that("plot_periodogram_a_p() | error test", {
  ...
  expect_error(
    plot_periodogram_a_p(
      p_seq = "", a_p = 1, x_label = "Period", print = FALSE
    ),
    "Assertion on 'p_seq' failed"
  )
  expect_error(
    plot_periodogram_a_p(
      p_seq = numeric(), a_p = 1, x_label = "Period", print = FALSE
    ),
    "Assertion on 'p_seq' failed"
  )
  ...
  expect_error(
    plot_periodogram_a_p(
      p_seq = 1, a_p = "", x_label = "Period", print = FALSE
    ),
    "Assertion on 'a_p' failed"
  )
  expect_error(
    plot_periodogram_a_p(
      p_seq = 1, a_p = numeric(), x_label = "Period", print = FALSE
    ),
    "Assertion on 'a_p' failed"
  )
  ...
  expect_error(
    plot_periodogram_a_p(
      p_seq = 1, a_p = 1, x_label = 1, print = FALSE
    ),
    "Assertion on 'x_label' failed"
  )

  # checkmate::assert_flag(print)
  expect_error(
    plot_periodogram_a_p(
      p_seq = 1, a_p = 1, x_label = "Period", print = 1
    ),
    "Assertion on 'print' failed"
  )
})
...
test_that("plot_periodogram_q_p() | general test", {
  ...
  per <- periodogram(
    data = data, col = "x", p_min = 1, p_max = 350,
    print = FALSE
  )

  expect_s3_class(
    plot_periodogram_q_p(
      p_seq = per$p_seq, q_p = per$q_p, q_p_critical = per$q_p_critical,
      alpha = 0.05, x_label = "Period", print = TRUE
    ),
    "ggplot"
  )
})
...
test_that("plot_periodogram_q_p() | error test", {
  ...
  expect_error(
    plot_periodogram_q_p(
      p_seq = "", q_p = 1, q_p_critical = 1, alpha = 0.1, x_label = "Period",
      print = FALSE
    ),
    "Assertion on 'p_seq' failed"
  )
  ...
  expect_error(
    plot_periodogram_q_p(
      p_seq = 1, q_p = "", q_p_critical = 1, alpha = 0.1, x_label = "Period",
      print = FALSE
    ),
    "Assertion on 'q_p' failed"
  )
  ...
  expect_error(
    plot_periodogram_q_p(
      p_seq = 1, q_p = 1, q_p_critical = "", alpha = 0.1, x_label = "Period",
      print = FALSE
    ),
    "Assertion on 'q_p_critical' failed"
  )
  ...
  expect_error(
    plot_periodogram_q_p(
      p_seq = 1, q_p = 1, q_p_critical = 1, alpha = "", x_label = "Period",
      print = FALSE
    ),
    "Assertion on 'alpha' failed"
  )
  expect_error(
    plot_periodogram_q_p(
      p_seq = 1, q_p = 1, q_p_critical = 1, alpha = -1, x_label = "Period",
      print = FALSE
    ),
    "Assertion on 'alpha' failed"
  )
  expect_error(
    plot_periodogram_q_p(
      p_seq = 1, q_p = 1, q_p_critical = 1, alpha = 2, x_label = "Period",
      print = FALSE
    ),
    "Assertion on 'alpha' failed"
  )
  ...
  expect_error(
    plot_periodogram_q_p(
      p_seq = 1, q_p = 1, q_p_critical = 1, alpha = 0.1, x_label = 1,
      print = FALSE
    ),
    "Assertion on 'x_label' failed"
  )
  ...
  expect_error(
    plot_periodogram_q_p(
      p_seq = 1, q_p = 1, q_p_critical = 1, alpha = 0.1, x_label = "Period",
      print = 1
    ),
    "Assertion on 'print' failed"
  )
